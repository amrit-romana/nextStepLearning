-- ============================================
-- TUTORING PLATFORM - SUPABASE SETUP
-- ============================================
...
DROP POLICY IF EXISTS "Students can create own record" ON students;
...
-- Students policies
CREATE POLICY "Students can create own record" ON students
...
-- ✓ enrollments
--
-- Default classes inserted for Year 8, 9, 10
